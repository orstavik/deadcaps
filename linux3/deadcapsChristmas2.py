# this is an experiment using only python to control the whole keyboard translation.
...
semidead = {
    'KEY_Q': [shift1, minus1, minus0, shift0, syn0],
    'KEY_W': [ralt1, rbrace1, rbrace0, ralt0, syn0],  #, space1, space0 # it doesn't work to add spaces at the end.. ah well..
#    'KEY_W': syn(rightAlt(downUp(libevdev.EV_KEY.KEY_RIGHTBRACE))),
    'KEY_E': [less1, less0, syn0],
    'KEY_R': [shift1, less1, less0, shift0, syn0],
    'KEY_T': [shift1, three1, three0, shift0, syn0],
    'KEY_Y': [shift1, six1, six0, shift0, syn0],
    'KEY_U': [ralt1, two1, two0, ralt0, syn0],
    'KEY_I': [shift1, zero1, zero0, shift0, syn0],
    'KEY_O': [minus1, minus0, syn0],
    'KEY_P': [shift1, five1, five0, shift0, syn0],

    'KEY_A': [ralt1, eight1, eight0, ralt0, syn0],
    'KEY_S': [ralt1, nine1, nine0, ralt0, syn0],
    'KEY_D': [shift1, eight1, eight0, shift0, syn0],
    'KEY_F': [shift1, nine1, nine0, shift0, syn0],
    'KEY_G': [shift1, bslash1, bslash0, shift0, syn0],
    'KEY_H': [shift1, two1, two0, shift0, syn0],
    'KEY_J': [bslash1, bslash0, syn0],
    'KEY_K': [shift1, seven1, seven0, shift0, syn0],
    'KEY_L': [shift1, one1, one0, shift0, syn0],
    #'KEY_SEMICOLON': syn(downUp(libevdev.EV_KEY.KEY_SEMICOLON)), # let it pass through?

    'KEY_Z': [ralt1, four1, four0, ralt0, syn0],
    'KEY_X': [ralt1, seven1, seven0, ralt0, syn0],
    'KEY_C': [ralt1, zero1, zero0, ralt0, syn0],
    'KEY_V': [shift1, four1, four0, shift0, syn0],
    #'KEY_B': [],
    'KEY_N': [grave1, grave0, syn0],
    'KEY_M': [shift1, equal1, equal0, shift0, syn0], # space1, space0,
    'KEY_COMMA': [equal1, equal0, syn0],
    'KEY_DOT': [shift1, rbrace1, rbrace0, shift0, syn0] #space1, space0,
        ...
        for e in d.events():
            ...
            if state == 'DEADCAPS':
                if key == 'KEY_CAPSLOCK':
                    ...
                    state = 'NORMAL'
                    uidev.send_events([shift1, e, shift0, syn0])
                continue
            ...
            if state == 'SEMIDEAD':
                state = 'NORMAL'
                uidev.send_events(semidead[key] if key in semidead else [e])
                continue
