1. setup `python3` against `libevdev2`. [python-libevdev](https://python-libevdev.readthedocs.io/en/latest/)
    * `sudo apt-get install -y python3-pip`
    * `sudo pip install libevdev`


2. make a test python script `hello.py`:
...
3. Here you need to find out which `/dev/input/eventX` that your mouse is connected to: `cat /proc/bus/input/devices`.
[explore the `/dev/input/` folder](https://thehackerdiary.wordpress.com/2017/04/21/exploring-devinput-1/)

4. then run it: `sudo python3 ./hello.py` 
